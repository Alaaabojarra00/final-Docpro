                      ...
                      <div className="col-lg-12 col-md-12 col-sm-12 content-column">
                        <div className="content_block_1">
                          <div className="content-box">
                            ...
                            <div className="text">
                              <p>
                                We are experts in the field of medical and
                                dental services. We observe local and national
                                legislation as well as safety requirements to
                                the our maintain the highest levels of corporate
                                integrity.{' '}
                              </p>
                            </div>
