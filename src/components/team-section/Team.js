              ...
              <div className="inner-box">
                ...
                <div className="content-box">
                  ...
                  <ul className="name-box clearfix">
                    <li className="name">
                      <h3>
                        <a href="profiles/doctor/FGHDFGH/index.html">FGHDFGH</a>
                      </h3>
                    </li>
                  ...
                  <span className="designaion"></span>
                  <div className="text">
                    <p></p>
                  </div>
                  <div className="rating-box clearfix">
                    ...
                    <div className="link">Not Available</div>
                  </div>
                  ...
                  <div className="btn-box">
                    <a href="profiles/doctor/FGHDFGH/index.html">Visit Now</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="inner-box">
                ...
                <div className="content-box">
                  ...
                  <ul className="name-box clearfix">
                    <li className="name">
                      <h3>
                        <a href="profiles/doctor/jimirani/index.html">
                          jimirani
                        </a>
                      </h3>
                    </li>
                  ...
                  <div className="btn-box">
                    <a href="profiles/doctor/jimirani/index.html">Visit Now</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              <div className="inner-box">
                ...
                <div className="content-box">
                  ...
                  <span className="designaion">
                    <span>SSC, HSC, MBBS, MRCP, DHA</span>
                    <span> - </span>
                    <span>Periodontology and BDS Khulna</span>
                  </span>
                  <div className="text">
                    <p>
                      Lorem ipsum dolor sit amet consectur adipisc elit sed
                  ...
                  <div className="rating-box clearfix">
                    ...
                    <div className="link">Available</div>
                  </div>
                  <div className="location-box">
                    <p>
                      <i className="fas fa-map-marker-alt"></i>56/2 Road-1
                      Gulshan, Dhaka
                    </p>
                  </div>
                  <div className="btn-box">
              ...
              <div className="inner-box">
                ...
                <div className="content-box">
                  ...
                  <ul className="name-box clearfix">
                    <li className="name">
                      <h3>
                        <a href="profiles/doctor/newdoctor2/index.html">
                          Aristor Aris
                        </a>
                      </h3>
                    </li>
                  ...
                  <div className="location-box">
                    <p>
                      <i className="fas fa-map-marker-alt"></i>11/9 Road-2,
                      Kurigram
                    </p>
                  </div>
                  <div className="btn-box">
